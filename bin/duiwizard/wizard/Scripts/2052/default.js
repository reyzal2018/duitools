...
function AddFilters(proj)
{
	try
	{
		...
		var strSouiFilter = wizard.FindSymbol('DUIRES_FILTER');
		var group = proj.Object.AddFilter('DUI Resouece');
...
function AddConfig(proj, strProjectName)
{
	try
	{
		...
		CLTool.AdditionalIncludeDirectories = '"$(DUIPATH)\\DuiLib"';
		CLTool.PreprocessorDefinitions = 'WIN32;_WINDOWS;_DEBUG;UILIB_STATIC;';
		...
		CLTool.WarningLevel = warningLevelOption.warningLevel_3;
		CLTool.AdditionalIncludeDirectories = '"$(DUIPATH)\\duilib";';
		CLTool.PreprocessorDefinitions = 'WIN32;_WINDOWS;NDEBUG;UILIB_STATIC;';
	...
	try
	{
		...
		while (!strTextStream.AtEndOfStream)
		{
			...
			if (strTpl != '')
			{
				...
				if(strExt==".bmp" || strExt==".png" || strExt==".ico" || strExt==".gif" || strExt==".rtf" || strExt==".css")
					bCopyOnly = true;
